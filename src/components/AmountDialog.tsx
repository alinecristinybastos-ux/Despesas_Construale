...
export default function AmountDialog({
  ...
  const valido = Number(value.replace(",", ".")) > 0;
    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/70 px-4 pb-8 sm:items-center">
      <div className="w-full max-w-sm rounded-2xl border border-border bg-surface p-5">
        ...
        <input
          ...
          className="mt-4 w-full rounded-xl border border-border bg-surface-2 px-4 py-3 font-ticket text-2xl font-bold text-foreground placeholder:text-muted focus:border-foreground focus:outline-none"
        />
